...
%             if i<1500
            ...
            tt.TileSpacing = 'none';
            set(gca,'Layer','top')
            saveas(hhh,sprintf('../figures/organics_newres_fig%d_imp_kc%dTlayer%dC.png',i,kc,Tlayer)); 
            saveas(hhh,sprintf('../figures/organics_pdfnewres_fig%d_imp_kc%dTlayer%dC.pdf',i,kc,Tlayer));
            ...
            if rem(i,100)==0
                            save(['../Output/impact_' fn '_eta0_' num2str(log10(eta_0)) 'kc' num2str(kc) '_Ea_' num2str(E_a/1e3) '_output_' num2str(i) 'Tlayer' num2str(Tlayer) 'C.mat'],...
                'Tplot','phi','Grid','phiDrain1Vec','phiDrain2Vec','phiOrig','tVec',...
