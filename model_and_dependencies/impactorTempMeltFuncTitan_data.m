function impactorTempMeltFuncTitan_data(fn,eta_0,E_a)
    %{
    ...
    Gridp.xmin = 0; Gridp.xmax = 3; Gridp.Nx = grRes; %radial direction
    ...
    %TGr_layer   = T(2,end)*ones(2*grZ,Grid.p.Nx);  %melting temperature in the ice %%%%
    ...
    for i = 1:1e9
        ...
        AH = build_adv_op(vm,H,dt,Gp,Grid.p,Param.H,'gd'); %Upwinding the enthalpy from center to faces
        ...
        Ac1 = build_adv_op(vm,trc1,dt,Gp,Grid.p,Param.c,'gd');%Upwinding the tracer conc. from center to faces
        ...
        Ac2 = build_adv_op(vm,trc2,dt,Gp,Grid.p,Param.c,'gd');%Upwinding the tracer conc. from center to faces
