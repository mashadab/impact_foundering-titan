...
reduce_image = grayscale_image[::compression_factor,::compression_factor]
X_reduced = x[::compression_factor,::compression_factor]  #radius in meters
Y_reduced = y[::compression_factor,::compression_factor]  #height in meters
...
#Plotting
plt.imshow(grayscale_image[::compression_factor,::compression_factor], cmap='gray', vmin=0, vmax=255)
